...
import CircleChart from './LearningChartComponent';


const LearningFormContainer = ({auth, currentStudentInfo, setCurrentStudentInfo, learnValues, setLearnValues}) => {
                ...
                <form onSubmit={e => handleLearnForm(e)} height={800}>
                    <fieldset className='fieldsets' name='group1' id='group1'>
                        ...
                        <div>
                            ...
                            <label>It doesn’t ring a bell or resonate</label>
                        </div>
                        <div>
                            <input checked type='radio' value='V' name='question1' />
                            <label>It seems hazy or unclear </label>
                        </div>
                        <div>
                            <input checked type='radio' value='K' name='question1' />
                            <label> You can’t get a handle on it or feel it </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group4' id='group4'>
                        ...
                        <div>
                            ...
                            <label> Someone explains the ideas to you </label>
                        </div>
                        <div>
                            <input type='radio' value='V' name='question4' checked />
                            <label> You visualize the concepts and see the whole picture </label>
                        </div>
                        <div>
                            <input type='radio' value='K' name='question4' checked />
                            <label> You can learn by doing or get a feel for the ideas </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group5' id='group5'>
                        ...
                        <div>
                            ...
                            <label> Cook something familiar? </label>
                        </div>
                        <div>
                            <input type='radio' value='V' name='question5' checked />
                            <label> Look through a cookbook for ideas? </label>
                        </div>
                        <div>
                            <input type='radio' value='A' name='question5' checked />
                            <label> Ask for the advice of others? </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group6' id='group6'>
                        ...
                        <div>
                            ...
                            <label> A friend speaking about it </label>
                        </div>
                        <div>
                            <input type='radio' value='K' name='question6' checked />
                            <label> How it makes you feel </label>
                        </div>
                        <div>
                            <input type='radio' value='V' name='question6' checked />
                            <label> Its distinctive look or appearance </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group7' id='group7'>
                        ...
                        <div>
                            ...
                            <label> Looking at the directions, pictures, diagrams, or charts </label>
                        </div>
                        <div>
                            <input type='radio' value='A' name='question7' checked />
                            <label> Listening to somebody explain it </label>
                        </div>
                        <div>
                            <input type='radio' value='K' name='question7' checked />
                            <label> Doing it </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group9' id='group9'>
                        ...
                        <div>
                            ...
                            <label> Read the instructions? </label>
                        </div>
                        <div>
                            <input type='radio' value='A' name='question9' checked />
                            <label> Call a friend and ask questions about it? </label>
                        </div>
                        <div>
                            <input type='radio' value='K' name='question9' checked />
                            <label> Turn it on and learn by experimentation? </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group10' id='group10'>
                        ...
                        <div>
                            ...
                            <label> The quality of music from a sound system </label>
                        </div>
                        <div>
                            <input type='radio' value='V' name='question10' checked />
                            <label> If colors, shapes, or patterns clash </label>
                        </div>
                        <div>
                            <input type='radio' value='K' name='question10' checked />
                            <label> If clothes feel uncomfortable </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group11' id='group11'>
                        ...
                        <div>
                            ...
                            <label> See the word in your mind and choose the best way it looks? </label>
                        </div>
                        <div>
                            <input type='radio' value='A' name='question11' checked />
                            <label> Sound it out? </label>
                        </div>
                        <div>
                            <input type='radio' value='K' name='question11' checked />
                            <label> Write down both versions? </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group12' id='group12'>
                        ...
                        <div>
                            ...
                            <label> Friends/family talking about it </label>
                        </div>
                        <div>
                            <input type='radio' value='K' name='question12' checked />
                            <label> You have an intuition or sense about it</label>
                        </div>
                        <div>
                            <input type='radio' value='V' name='question12' checked />
                            <label> You saw a preview of it </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group13' id='group13'>
                        ...
                        <div>
                            ...
                            <label> Repeat them to yourself as you hear them </label>
                        </div>
                        <div>
                            <input type='radio' value='V' name='question13' checked />
                            <label> Visualize them </label>
                        </div>
                        <div>
                            <input type='radio' value='K' name='question13' checked />
                            <label> Intuitively sense how to get there </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group14' id='group14'>
                        ...
                        <div>
                            ...
                            <label> Handouts, flow diagrams, charts, and visuals? </label>
                        </div>
                        <div>
                            <input type='radio' value='K' name='question14' checked />
                            <label> Field trips, experiments, and applications? </label>
                        </div>
                        <div>
                            <input type='radio' value='A' name='question14' checked />
                            <label> Discussions, guest speakers, and conversations? </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group15' id='group15'>
                        ...
                        <div>
                            ...
                            <label> It is now concrete, or you have a feel for it </label>
                        </div>
                        <div>
                            <input type='radio' value='A' name='question15' checked />
                            <label> You have it loud and clear </label>
                        </div>
                        <div>
                            <input type='radio' value='V' name='question15' checked />
                            <label> You can envision it </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group16' id='group16'>
                        ...
                        <div>
                            ...
                            <label> Your gut instinct </label>
                        </div>
                        <div>
                            <input type='radio' value='V' name='question16' checked />
                            <label> What looks clearest to you </label>
                        </div>
                        <div>
                            <input type='radio' value='A' name='question16' checked />
                            <label> What sounds best to you </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className='fieldsets' name='group17' id='group17'>
                        ...
                        <div>
                            ...
                            <label> Are interesting and articulate speakers </label>
                        </div>
                        <div>
                            <input type='radio' value='K' name='question17' checked />
                            <label> Convey a warm and relaxing feeling </label>
                        </div>
                        <div>
                            <input type='radio' value='V' name='question17' checked />
                            <label> Radiate a visual beauty </label>
                        </div>
                    </fieldset>
