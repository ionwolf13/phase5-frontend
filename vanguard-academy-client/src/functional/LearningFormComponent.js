            ...
            <div>
                ...
                <form onSubmit={e => handleLearnForm(e)} height={800}>
                    ...
                    <fieldset name='group3' id='group3'>
                        <label>3. You are staying in a hotel and have a rental car. You would like to visit a friend whose address you do not know. Would you like them to: </label><br></br>
                    ...
                    <fieldset name='group4' id='group4'>
                        <label>4. Learning technical material is easiest for you when: </label><br></br>
                    ...
                    <fieldset name='group5' id='group5'>
                        <label>5. You are going to cook a dessert as a special treat for your family. Do you: </label><br></br>
                    ...
                    <fieldset name='group6' id='group6'>
                        <label>6. You are about to purchase a new sound system. Other than the price, what would most influence your decision? </label><br></br>
                    ...
                    <fieldset name='group7' id='group7'>
                        <label>7. Recall a time in your life when you learned how to do something like playing a new board game. Try to avoid choosing a very physical skill like riding a bike. How did you learn best? By: </label><br></br>
                    ...
                    <fieldset name='group8' id='group8'>
                        <label>8. Which of these games to you prefer? </label><br></br>
                    ...
                    <fieldset name='group9' id='group9'>
                        <label>9. You are about to learn how to use a new program on a computer. Would you: </label><br></br>
                    ...
                    <fieldset name='group10' id='group10'>
                        <label>10. You most easily are aware of and notice: </label><br></br>
                    ...
                    <fieldset name='group11' id='group11'>
                        <label>11. You are not sure whether a word should be spelled “separate” or “seperate.” Do you: </label><br></br>
                    ...
                    <fieldset name='group12' id='group12'>
                        <label>12. A new movie has arrived in town. What would most influence your decision to go or not go? </label><br></br>
                    ...
                    <fieldset name='group13' id='group13'>
                        <label>13. You most easily remember directions when you: </label><br></br>
                    ...
                    <fieldset name='group14' id='group14'>
                        <label>14. Do you prefer a teacher or trainer who likes to use: </label><br></br>
                    ...
                    <fieldset name='group15' id='group15'>
                        <label>15. Once you completely understand a new idea: </label><br></br>
                    ...
                    <fieldset name='group16' id='group16'>
                        <label>16. You make decisions best when you rely on: </label><br></br>
                    ...
                    <fieldset name='group17' id='group17'>
                        <label>17. At a party, you are most interested in people who </label><br></br>
